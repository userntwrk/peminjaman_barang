           ...
           // echo $file_name." ".$file_type." ".$file_size." ".$nama_barang." ".$stok_barang." ".$extension;
            if(($extension == "jpg" || $extension == "jpeg" || $extension == "gif" || $extension == "png") && ($file_type == "image/jpeg" || $file_type == "image/png" || $file_type=="image/gif") && $extension == $file_size<=$max_size){
                ...
                if (move_uploaded_file($tmp_name, $location.$file_name)) {
                    if(mysqli_query($koneksi, "INSERT INTO tbl_barang (nama_barang, merk_barang, gambar_barang, stok_barang, tahun_barang) VALUES ('$nama_barang', '$merk_barang', '$file_name', '$stok_barang', '$tahun_barang')")){
                        ...
                        <div class="card">
                          ...
                          <form class="card-body card-block" action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="merk" name="merk_barang" placeholder="contoh: logitech" class="form-control"> 
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" id="tahun" name="tahun_barang" placeholder="contoh: 2020" class="form-control"> 
                            </div>
