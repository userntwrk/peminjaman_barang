	...
	if(isset($_GET['mode']) && !empty($_GET['mode'])){
		...
		if($_GET['mode'] == "terima"){
			...
			if($data_search_barang){
				$update_stok = mysqli_query($koneksi, "UPDATE tbl_barang SET stok_barang = '$stok_barang' WHERE nama_barang = '$nama_barang_request'");
				if($update_stok){
					if(mysqli_query($koneksi, "INSERT INTO tbl_pinjam (nama_barang, merk_barang, peminjam, level, jml_barang, tahun_barang, tgl_pinjam, tgl_kembali) VALUES ('$nama_barang_request', '$merk_barang_request', '$peminjam_request', '$level_request', '$jml_barang_request', '$tahun_barang_request', '$tgl_pinjam_request', '$tgl_kembali_request')")){
						if(mysqli_query($koneksi, "DELETE FROM tbl_request WHERE id = '$id_request'")){
							...
							if(mysqli_query($koneksi, "INSERT INTO pemberitahuan (username, konten, status) VALUES ('$peminjam_request', '$konten', 'terima')")){
			...
			if(mysqli_query($koneksi, "DELETE FROM tbl_request WHERE id = '$id_request'")){
				...
				if(mysqli_query($koneksi, "INSERT INTO pemberitahuan (username, konten, status) VALUES ('$peminjam_request', '$konten', 'tolak')")){
