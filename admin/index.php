...
<head>
    ...
    <title>Admin - Peminjaman Instrumen Lab</title>
                ...
                <div class="card text-white bg-flat-color-2">
                    <div class="card-body pb-0">
                        <h4 class="mb-0">
                            <span class="count">
                                <?php
                                    $query_barang = mysqli_query($koneksi, "SELECT SUM(stok_barang) AS stok FROM tbl_barang");
                ...
                <div class="card text-white bg-flat-color-3">
                    <div class="card-body pb-0">
                        <h4 class="mb-0">
                            <span class="count">
                                <?php
                                    $query_request = mysqli_query($koneksi, "SELECT COUNT(*) AS total_req_pinjam FROM tbl_request");
                ...
                <div class="card text-white bg-flat-color-4">
                    <div class="card-body pb-0">
                        <h4 class="mb-0">
                            <span class="count">
                                <?php
                                    $query_barang_pinjam = mysqli_query($koneksi, "SELECT SUM(jml_barang) AS jml_barnag FROM tbl_pinjam");
