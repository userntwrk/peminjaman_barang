<?php
	...
	if(isset($_POST['daftar'])){
		...
		if(mysqli_query($koneksi, "INSERT INTO user (nama, username, password, level) VALUES ('$nama', '$username', '$password', '$level')")){
...
<html>
<head>
	<title>Register | Peminjaman Instrumen Lab</title>
