			...
			<div class="container">
				<div class="row">
					<div class="col-sm-8">
						...
						<p class="text-muted">Peminjaman Instrumen Lab adalah aplikasi berbasis web yang dibuat dengan tujuan untuk mempermudah penanganan di bidang sarana & prasarana. Serta menyesuaikan diri dengan semakin majunya Teknologi Informasi</p>
		...
		<div class="navbar navbar-dark bg-dark shadow-sm">
			<div class="container">
				<a class="navbar-brand align-items-center" style="color:#fff;">
					<strong> Peminjaman Instrumen Lab</strong>
				</a>
	...
	<main role="main">
		<section class="jumbotron text-center" style="background: #fff;">
			<div class="container">
				...
				?>
				<h1 class="jumbotron-heading" style="font-style: italic;">Daftar Instrumen Lab</h1>
				<p>Pilih Instrumen Lab yang ingin dipinjam dari daftar barang dibawah</p>
			</div>
		</section>
			...
			<div class="container">
				<div class="row">
					<?php
						...
						$query = mysqli_query($koneksi, "SELECT * FROM tbl_barang ORDER BY id ASC");											
