<?php
	...
	if(!empty($_GET['username']) && $_GET['username'] != ""){
		...
		$search_barang 	= mysqli_query($koneksi, "SELECT * FROM tbl_barang WHERE id='$id_barang'");
...
<html>
<head>
	<title>Peminjaman | Peminjaman Instrumen Lab</title>
		...
		<div class='row'>
			...
			<div class="col-md-4 form-register-container">
				...
				<form action="request-barang.php" method="post">
					...
					<input class="form-control" type="" name="merk_barang" required>
					<label>Jumlah barang</label>
					<input class="form-control" type="number" name="jml_barang" required>
					<label>Tahun barang</label>
					<input class="form-control" type="number" name="tahun_barang" required>
