<?php
	...
	if(isset($_POST['request-pinjam'])){
		...
		$query_insert_req   = mysqli_query($koneksi, "INSERT INTO tbl_request (nama_barang, merk_barang,peminjam, level, jml_barang, tahun_barang,tgl_pinjam, tgl_kembali) VALUES ('$nama_barang', '$merk_barang', '$username', '$level', '$jml_barang', '$tahun_barang', '$tgl_pinjam', '$tgl_kembali')");
		if($query_insert_req){
...
?>
		...
		<html>
		<head>
			<title>Request berhasil | Peminjaman Instrumen Lab</title>
